                               ...
                               uint64_t time_usec, uint8_t estimator_type, int32_t lat, int32_t lon, int32_t alt, int32_t relative_alt, float vx, float vy, float vz, const float *covariance)
{
    ...
    _mav_put_float(msg->payloads, 24, vx);
    _mav_put_float(msg->payloads, 28, vy);
    _mav_put_float(msg->payloads, 32, vz);
    _mav_put_uint8_t(msg->payloads, 180, estimator_type);
    _mav_put_float_array(msg->payloads, 36, covariance, 36);
