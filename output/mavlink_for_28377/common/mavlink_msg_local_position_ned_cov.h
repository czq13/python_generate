                               ...
                               uint64_t time_usec, uint8_t estimator_type, float x, float y, float z, float vx, float vy, float vz, float ax, float ay, float az, const float *covariance)
{
    ...
    _mav_put_float(msg->payloads, 20, vx);
    _mav_put_float(msg->payloads, 24, vy);
    _mav_put_float(msg->payloads, 28, vz);
    _mav_put_float(msg->payloads, 32, ax);
    _mav_put_float(msg->payloads, 36, ay);
    _mav_put_float(msg->payloads, 40, az);
    _mav_put_uint8_t(msg->payloads, 224, estimator_type);
    _mav_put_float_array(msg->payloads, 44, covariance, 45);
