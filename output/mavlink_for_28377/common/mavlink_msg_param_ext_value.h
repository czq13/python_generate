#ifndef MAVLINK_MSG_param_ext_value
#define MAVLINK_MSG_param_ext_value
...
{
    _mav_put_uint16_t(((char*)msg->payloads), 0, param_count);
    _mav_put_uint16_t(((char*)msg->payloads), 2, param_index);
    _mav_put_uint8_t(((char*)msg->payloads), 148, param_type);
    _mav_put_char_array(((char*)msg->payloads), 4, param_id, 16);
    _mav_put_char_array(((char*)msg->payloads), 20, param_value, 128);
