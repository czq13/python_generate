...
{
    _mav_put_uint16_t(msg->payloads, 0, param_count);
    _mav_put_uint16_t(msg->payloads, 2, param_index);
    _mav_put_uint8_t(msg->payloads, 148, param_type);
    _mav_put_char_array(msg->payloads, 4, param_id, 16);
    _mav_put_char_array(msg->payloads, 20, param_value, 128);
