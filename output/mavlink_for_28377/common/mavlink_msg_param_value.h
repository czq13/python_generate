                               ...
                               const char *param_id, float param_value, uint8_t param_type, uint16_t param_count, uint16_t param_index)
{
    ...
    _mav_put_uint16_t(((char*)msg->payloads), 4, param_count);
    _mav_put_uint16_t(((char*)msg->payloads), 6, param_index);
    _mav_put_uint8_t(((char*)msg->payloads), 24, param_type);
    _mav_put_char_array(((char*)msg->payloads), 8, param_id, 16);
