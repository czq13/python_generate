                               ...
                               uint8_t target_system, uint8_t target_component, const uint8_t *id_or_mac, uint8_t status, uint16_t direction, uint16_t speed_horizontal, int16_t speed_vertical, int32_t latitude, int32_t longitude, float altitude_barometric, float altitude_geodetic, uint8_t height_reference, float height, uint8_t horizontal_accuracy, uint8_t vertical_accuracy, uint8_t barometer_accuracy, uint8_t speed_accuracy, float timestamp, uint8_t timestamp_accuracy)
{
    ...
    _mav_put_float(msg->payloads, 8, altitude_barometric);
    _mav_put_float(msg->payloads, 12, altitude_geodetic);
    _mav_put_float(msg->payloads, 16, height);
    _mav_put_float(msg->payloads, 20, timestamp);
    _mav_put_uint16_t(msg->payloads, 24, direction);
    _mav_put_uint16_t(msg->payloads, 26, speed_horizontal);
    _mav_put_int16_t(msg->payloads, 28, speed_vertical);
    _mav_put_uint8_t(msg->payloads, 30, target_system);
    _mav_put_uint8_t(msg->payloads, 31, target_component);
    _mav_put_uint8_t(msg->payloads, 52, status);
    _mav_put_uint8_t(msg->payloads, 53, height_reference);
    _mav_put_uint8_t(msg->payloads, 54, horizontal_accuracy);
    _mav_put_uint8_t(msg->payloads, 55, vertical_accuracy);
    _mav_put_uint8_t(msg->payloads, 56, barometer_accuracy);
    _mav_put_uint8_t(msg->payloads, 57, speed_accuracy);
    _mav_put_uint8_t(msg->payloads, 58, timestamp_accuracy);
    _mav_put_uint8_t_array(msg->payloads, 32, id_or_mac, 20);
