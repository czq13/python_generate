                               ...
                               uint32_t timestamp, uint8_t type, uint8_t autopilot, uint16_t custom_mode, int32_t latitude, int32_t longitude, int16_t altitude, int16_t target_altitude, uint8_t heading, uint8_t target_heading, uint16_t target_distance, uint8_t throttle, uint8_t airspeed, uint8_t airspeed_sp, uint8_t groundspeed, uint8_t windspeed, uint8_t wind_heading, uint8_t eph, uint8_t epv, int8_t temperature_air, int8_t climb_rate, int8_t battery, uint16_t wp_num, uint16_t failure_flags, int8_t custom0, int8_t custom1, int8_t custom2)
{
    ...
    _mav_put_uint16_t(((char*)msg->payloads), 12, custom_mode);
    _mav_put_int16_t(((char*)msg->payloads), 14, altitude);
    _mav_put_int16_t(((char*)msg->payloads), 16, target_altitude);
    _mav_put_uint16_t(((char*)msg->payloads), 18, target_distance);
    _mav_put_uint16_t(((char*)msg->payloads), 20, wp_num);
    _mav_put_uint16_t(((char*)msg->payloads), 22, failure_flags);
    _mav_put_uint8_t(((char*)msg->payloads), 24, type);
    _mav_put_uint8_t(((char*)msg->payloads), 25, autopilot);
    _mav_put_uint8_t(((char*)msg->payloads), 26, heading);
    _mav_put_uint8_t(((char*)msg->payloads), 27, target_heading);
    _mav_put_uint8_t(((char*)msg->payloads), 28, throttle);
    ...
    _mav_put_uint8_t(((char*)msg->payloads), 32, windspeed);
    _mav_put_uint8_t(((char*)msg->payloads), 33, wind_heading);
    _mav_put_uint8_t(((char*)msg->payloads), 34, eph);
    _mav_put_uint8_t(((char*)msg->payloads), 35, epv);
    _mav_put_int8_t(((char*)msg->payloads), 36, temperature_air);
    _mav_put_int8_t(((char*)msg->payloads), 37, climb_rate);
    _mav_put_int8_t(((char*)msg->payloads), 38, battery);
    _mav_put_int8_t(((char*)msg->payloads), 39, custom0);
    _mav_put_int8_t(((char*)msg->payloads), 40, custom1);
    _mav_put_int8_t(((char*)msg->payloads), 41, custom2);
