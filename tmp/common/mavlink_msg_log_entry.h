...
{
    _mav_put_uint32_t(msg->payloads, 0, time_utc);
    _mav_put_uint32_t(msg->payloads, 4, size);
    _mav_put_uint16_t(msg->payloads, 8, id);
    _mav_put_uint16_t(msg->payloads, 10, num_logs);
    _mav_put_uint16_t(msg->payloads, 12, last_log_num);
