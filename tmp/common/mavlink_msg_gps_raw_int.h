                               ...
                               uint64_t time_usec, uint8_t fix_type, int32_t lat, int32_t lon, int32_t alt, uint16_t eph, uint16_t epv, uint16_t vel, uint16_t cog, uint8_t satellites_visible, int32_t alt_ellipsoid, uint32_t h_acc, uint32_t v_acc, uint32_t vel_acc, uint32_t hdg_acc, uint16_t yaw)
{
    ...
    _mav_put_uint16_t(msg->payloads, 26, cog);
    _mav_put_uint8_t(msg->payloads, 28, fix_type);
    _mav_put_uint8_t(msg->payloads, 29, satellites_visible);
    _mav_put_int32_t(msg->payloads, 30, alt_ellipsoid);
    _mav_put_uint32_t(msg->payloads, 34, h_acc);
    _mav_put_uint32_t(msg->payloads, 38, v_acc);
    _mav_put_uint32_t(msg->payloads, 42, vel_acc);
    _mav_put_uint32_t(msg->payloads, 46, hdg_acc);
    _mav_put_uint16_t(msg->payloads, 50, yaw);
